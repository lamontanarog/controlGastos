...
//El contexto ContextApp se crea utilizando la función createContext() de React
...
const ProviderApp = ({ children }) => {
    ...
    //La función addTransaction se utiliza para agregar una nueva transacción al estado transactions. 
    ...
    return (
        <ContextApp.Provider value={{ transactions, addTransaction, totalBalance, expenses, incomes, totalIncome, totalExpense }}>
